...
public class InspectionController {
	...
	@PostMapping
	public ResponseEntity<ResponseDto<InspectionResponse>> registerInspection(@RequestBody InspectionRequest request,
	...
	public ResponseEntity<ResponseDto<InspectionResponse>> updateInspection(@PathVariable Long inspectionId,
		@RequestBody InspectionRequest request, @CurrentUser User currentUser) {
	...
	public ResponseEntity<ResponseDto<InspectionResponse>> getInspection(@PathVariable Long inspectionId,
		@CurrentUser User currentUser) {
	...
	public ResponseEntity<ResponseDto<Void>> deleteInspection(@PathVariable Long inspectionId,
		@CurrentUser User currentUser) {
